...
For areas of dumb fuzzing, we have tried to factor the code so code duplication is minimalised (common function for empty payload test), for a clean compact codebase.
